    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "JavaScript Snake by: Patrick Gillespie<p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Easter Egg 1<p></p>You died. Thanks for playing!<p></p>";
